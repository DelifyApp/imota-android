...
public class SharedHelper {
    ...
    public static void putKey(Context context, String Key, String Value) {
        sharedPreferences = context.getSharedPreferences(BuildConfig.APPLICATION_ID,
    ...
    public static void putKeyFCM(Context context, String Key, String Value) {
        sharedPreferences = context.getSharedPreferences(BuildConfig.APPLICATION_ID + ".fcm",
                Context.MODE_PRIVATE);
        editor = sharedPreferences.edit();
        editor.putString(Key, Value);
        editor.apply();
    ...
    public static LatLng getCurrentLocation(Context context) {
        ...
        return new LatLng(sharedPreferences.getFloat("current_lat", 0),
                sharedPreferences.getFloat("current_lng", 0));
    }
