package com.codedapp.user.data.network;
...
import com.codedapp.user.data.network.model.CancelResponse;
...
import com.codedapp.user.data.network.model.Coupon;
import com.codedapp.user.data.network.model.DataResponse;
import com.codedapp.user.data.network.model.Datum;
import com.codedapp.user.data.network.model.DisputeResponse;
...
import com.codedapp.user.data.network.model.Rental;
...
import com.codedapp.user.ui.activity.register.OtpREsponse;
...
public interface ApiInterface {
    ...
    Observable<OtpREsponse> verifyCredentials(@Field("mobile") String mobileNumber, @Field("country_code") String countryCode);
    ...
    Observable<OtpREsponse> verifyOtps(@Field("mobile") String phoneNumber, @Field("otp") String otp);
}
