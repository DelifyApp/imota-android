...
public class ChangePasswordActivity extends BaseActivity implements ChangePasswordIView {
    ...
    private ChangePasswordPresenter<ChangePasswordActivity> presenter =
    ...
    public void onViewClicked() {
        hideSoftInputWindow(changePassword);
        if (oldPassword.getText().toString().isEmpty()) {
            Toast.makeText(this, getString(R.string.invalid_current_password),
        ...
        if (password.getText().toString().equals(oldPassword.getText().toString())) {
            Toast.makeText(getApplicationContext(),
                    getResources().getString(R.string.same_password), Toast.LENGTH_SHORT).show();
            password.requestFocus();
            return;
        }
    ...
    private void showLoginDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(this)
                .setMessage(getResources().getString(R.string.login_again))
