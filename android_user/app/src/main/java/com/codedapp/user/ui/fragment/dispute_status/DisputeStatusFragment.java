package com.codedapp.user.ui.fragment.dispute_status;
...
import com.codedapp.user.data.network.model.Dispute;
...
public class DisputeStatusFragment extends BaseBottomSheetDialogFragment implements DisputeStatusIView, View.OnClickListener {
    ...
    public void initView(View view) {
        ...
        Datum datum = (Datum) Objects.requireNonNull(getArguments()).getSerializable(TRIP_KEY);
