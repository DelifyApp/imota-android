...
import com.codedapp.user.ui.activity.change_password.ChangePasswordActivity;
import com.codedapp.user.ui.countrypicker.Country;
...
public class ProfileActivity extends BaseActivity implements ProfileIView {
            ...
            if (!loginResult.wasCancelled())
                AccountKit.getCurrentAccount(new AccountKitCallback<Account>() {
                    ...
                    public void onSuccess(Account account) {
                        Log.d("AccountKit",
                                "onSuccess: Account Kit" + Objects.requireNonNull(AccountKit.getCurrentAccessToken()).getToken());
                        if (Objects.requireNonNull(AccountKit.getCurrentAccessToken()).getToken() != null) {
                            PhoneNumber phoneNumber = account.getPhoneNumber();
                            SharedHelper.putKey(ProfileActivity.this, "country_code",
                                    "+" + phoneNumber.getCountryCode());
                            SharedHelper.putKey(ProfileActivity.this, "mobile",
                                    phoneNumber.getPhoneNumber());
                            mobile.setText(phoneNumber.getPhoneNumber());
                            profilePresenter.verifyCredentials(phoneNumber.getPhoneNumber(),
                                    "+" + phoneNumber.getCountryCode());
                        }
                    }
    ...
    private void updateDetails() {
        ...
        map.put("first_name", RequestBody.create(MediaType.parse("text/plain"),
                firstName.getText().toString()));
        map.put("last_name", RequestBody.create(MediaType.parse("text/plain"),
        ...
        map.put("country_code", RequestBody.create(MediaType.parse("text/plain"),
                SharedHelper.getKey(ProfileActivity.this, "country_code")));
            ...
            case REQUEST_PERMISSION:
                if (grantResults.length > 0) {
                    ...
                    if (permission1 && permission2) pickImage();
                        ...
                        Toast.makeText(getApplicationContext(), R.string.please_give_permissions,
    ...
    public void onSuccess(@NonNull User user) {
        ...
        changePassword.setVisibility(loginBy.equalsIgnoreCase("facebook")
                || loginBy.equalsIgnoreCase("google") ? View.INVISIBLE : View.VISIBLE);
        ...
        qrCodeUrl = !TextUtils.isEmpty(user.getQrcode_url()) ?
                BuildConfig.BASE_URL + user.getQrcode_url() : null;
