...
import com.codedapp.user.ui.countrypicker.CountryPicker;
...
//        setTitle(getString(R.string.register));
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.next:
                ...
                if (validate()) {
                    registerPresenter.verifyCredentials(phoneNumber.getText().toString().trim(), countryDialCode);
    ...
    private void register() {
        ...
        showLoading();
        //   registerPresenter.verifyCredentials(SharedHelper.getKey(this, "mobile"),SharedHelper.getKey(this, "countryCode"));
    ...
    public void onSuccessPhoneNumber(OtpREsponse object) {
        Log.e("user", "onSuccessPhoneNumber: "+object);
        ...
        if (!referralCodeEdit.getText().toString().trim().isEmpty())
            intent.putExtra("referral_code", referralCodeEdit.getText().toString().trim());
        startActivity(intent);
