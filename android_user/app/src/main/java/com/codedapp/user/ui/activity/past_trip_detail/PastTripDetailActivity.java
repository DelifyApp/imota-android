...
import com.codedapp.user.data.network.model.Rating;
import com.codedapp.user.ui.fragment.InvoiceDialogFragment;
import com.codedapp.user.ui.fragment.dispute.DisputeCallBack;
import com.codedapp.user.ui.fragment.dispute.DisputeFragment;
import com.codedapp.user.ui.fragment.dispute_status.DisputeStatusFragment;
import com.codedapp.user.ui.fragment.lost_item.LostFragment;
import com.codedapp.user.ui.fragment.lost_item_status.LostItemStatusFragment;
...
public class PastTripDetailActivity extends BaseActivity implements PastTripDetailsIView,
    ...
    private PastTripDetailsPresenter<PastTripDetailActivity> presenter =
            new PastTripDetailsPresenter();
    ...
    public void onAttachFragment(Fragment fragment) {
        ...
        else if (fragment instanceof LostFragment) ((LostFragment) fragment).setCallBack(this);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_dispute:
                if (isDisputeCreated) {
                    DisputeStatusFragment disputeDetailFragment =
                            DisputeStatusFragment.newInstance(datum);
                    disputeDetailFragment.show(getSupportFragmentManager(),
                            disputeDetailFragment.getTag());
                } else {
            ...
            case R.id.action_lost_my_item:
                if (isLostItemCreated) {
                    LostItemStatusFragment lostItemStatusFragment =
                            LostItemStatusFragment.newInstance(datum);
                    lostItemStatusFragment.show(getSupportFragmentManager(),
                            lostItemStatusFragment.getTag());
                } else {
        ...
        if (datum != null) {
            ...
            if (provider != null) {
                Glide.with(baseActivity())
                        ...
                        .into(avatar);
                name.setText(String.format("%s %s", provider.getFirstName(),
            ...
            if (payment != null)
                payable.setText(new StringBuilder(currencyBuilder)
                        .append(getNumberFormat().format(payment.getTotal())));
        }
    }
