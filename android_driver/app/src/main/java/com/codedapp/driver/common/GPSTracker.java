package com.codedapp.driver.common;
...
import com.codedapp.driver.common.kalman.KalmanLocationManager;
            ...
            if (location.getProvider().equals(KalmanLocationManager.KALMAN_PROVIDER)) {
                ...
                if (DATUM.getStatus() != null) {
                    if (DATUM.getStatus().equalsIgnoreCase("ACCEPTED")
                        ...
                        if (count % 2 == 0)
                            saveLocationToFireBaseDB(mLastKnownLocation.getLatitude(),
