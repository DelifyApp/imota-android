...
import com.codedapp.driver.ui.activity.change_password.ChangePasswordActivtiy;
                ...
                AccountKit.getCurrentAccount(new AccountKitCallback<Account>() {
                    ...
                    public void onSuccess(Account account) {
                        ...
                        if (Objects.requireNonNull(AccountKit.getCurrentAccessToken()).getToken() != null) {
                            ...
                            SharedHelper.putKey(ProfileActivity.this,
                                    Constants.SharedPref.DIAL_CODE,
                                    "+" + phoneNumber.getCountryCode());
                            SharedHelper.putKey(ProfileActivity.this, Constants.SharedPref.MOBILE
                                    , phoneNumber.getPhoneNumber());
                            txtPhoneNumber.setText(phoneNumber.getPhoneNumber());
                            presenter.verifyCredentials("+" + phoneNumber.getCountryCode(),
                                    phoneNumber.getPhoneNumber());
                        }
                    }
