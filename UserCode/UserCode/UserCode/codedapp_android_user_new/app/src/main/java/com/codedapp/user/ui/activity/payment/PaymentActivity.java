package com.codedapp.user.ui.activity.payment;
...
import static com.codedapp.user.MvpApplication.isBraintree;
import static com.codedapp.user.MvpApplication.isCard;
import static com.codedapp.user.MvpApplication.isCash;
import static com.codedapp.user.MvpApplication.isPaytm;
import static com.codedapp.user.MvpApplication.isPayumoney;
import static com.codedapp.user.common.Constants.PaymentMode.CASH;
...
import static com.codedapp.user.ui.fragment.invoice.InvoiceFragment.isInvoiceCashToCard;
...
/*        Intent intent = new Intent(this, PayuMoneyActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (data != null) if (requestCode == STRIPE_PAYMENT_REQUEST_CODE) {
            ...
            Toasty.success(PaymentActivity.this, "Payment nonce " + paymentNonce,
