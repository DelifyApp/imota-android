...
import com.codedapp.user.ui.activity.upcoming_trip_detail.UpcomingTripDetailActivity;
        ...
        public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            public void onClick(View view) {
                ...
                if (view.getId() == R.id.item_view) {
                    ...
                    cancelRideDialogFragment.show(baseActivity().getSupportFragmentManager(),
